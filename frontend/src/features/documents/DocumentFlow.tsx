...
function FormSection({ title, children }: { title: string; children: React.ReactNode }) { return <section className="border border-slate-200 bg-white px-4 py-5 first:mt-0 sm:px-6"><h2 className="typo-eyebrow border-b border-slate-200 pb-3 text-slate-600">{title}</h2><div className="mt-4">{children}</div></section> }
