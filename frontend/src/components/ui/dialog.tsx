...
export const DialogTitle = ({ className = '', ...props }: ComponentProps<typeof DialogPrimitive.Title>) => <DialogPrimitive.Title className={`text-lg font-bold text-slate-950 ${className}`} {...props} />
export const DialogDescription = ({ className = '', ...props }: ComponentProps<typeof DialogPrimitive.Description>) => <DialogPrimitive.Description className={`text-sm text-slate-600 ${className}`} {...props} />
