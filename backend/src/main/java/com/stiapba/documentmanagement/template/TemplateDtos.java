...
public final class TemplateDtos {
    ...
    public record TemplateResponse(UUID id, String nombre, String descripcion, boolean active,
                                   OffsetDateTime createdAt, OffsetDateTime updatedAt) {
    }

    public record TemplateVariantResponse(UUID id, UUID templateId, String nombre, boolean active,
                                          OffsetDateTime createdAt, OffsetDateTime updatedAt) {
    }
}
