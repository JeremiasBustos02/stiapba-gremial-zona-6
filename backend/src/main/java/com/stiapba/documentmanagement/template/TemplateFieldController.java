...
public class TemplateFieldController {
    ...
    @PutMapping public List<TemplateFieldService.TemplateFieldResponse> replaceAll(@PathVariable UUID templateId, @PathVariable UUID variantId, @Valid @RequestBody TemplateFieldService.FieldsConfigurationRequest request) { return service.replaceAll(templateId, variantId, request); }
